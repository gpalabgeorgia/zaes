	...
	<div id="carouselBlk">
		<div id="myCarousel" class="carousel slide">
			<div class="carousel-inner">
				...
				<div class="item">
					<div class="container">
						<a href="#"><img style="width:100%" src="{{ asset('images/front_images/carousel/2.png') }}" alt="Banner"/></a>
						<div class="carousel-caption">
				...
				<div class="item">
					<div class="container">
						<a href="register.html"><img src="{{ asset('images/front_images/carousel/3.png') }}" alt="Banner"/></a>
						<div class="carousel-caption">
